-- Create Test Data for Predictive Stocking System (Complete)
-- This script creates test equipment and materials data for independent testing

-- 1. Insert test equipment data (with ALL required columns)
INSERT INTO equipment (
  ...
  ('EQUIP-001', 'Excavator-01', 'Excavator', 'CAT 320', 'Site A', 'Class A', true, 30, 2500.00, 'available'),
  ('EQUIP-002', 'Bulldozer-01', 'Bulldozer', 'CAT D6', 'Site A', 'Class B', true, 45, 1800.00, 'available'),
  ('EQUIP-003', 'Crane-01', 'Crane', 'Liebherr LTM', 'Site B', 'Class C', true, 90, 3500.00, 'available'),
  ('EQUIP-004', 'Loader-01', 'Loader', 'CAT 950', 'Site A', 'Class A', true, 30, 2000.00, 'available'),
  ('EQUIP-005', 'Paver-01', 'Asphalt Paver', 'CAT AP655', 'Site B', 'Class B', true, 60, 2200.00, 'available');
