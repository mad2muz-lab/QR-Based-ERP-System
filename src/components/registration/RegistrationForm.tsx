    ...
    try {
      ...
      if (editingEquipment) {
        ...
        if (useSupabase) {
          ...
          console.log('🔍 RegistrationForm - equipmentData:', equipmentData);
          
          // Create equipment object without id field to let Supabase auto-generate it
          const newEquipment: Omit<Equipment, 'id'> = {
            ...
            operational_status: equipmentData.operational_status,
            serialNumber: equipmentData.serialNumber,
            oldId: equipmentData.oldId,
            costCenterCode: equipmentData.costCenterCode,
            profitCenterCode: equipmentData.profitCenterCode,
            hourly_rate: equipmentData.hourly_rate,
            createdAt: new Date().toISOString(),
            lastUpdated: new Date().toISOString()
          };
          
          console.log('🔍 RegistrationForm - newEquipment:', newEquipment);
          console.log('🔍 RegistrationForm - newEquipment keys:', Object.keys(newEquipment));
          console.log('🔍 RegistrationForm - newEquipment has id:', 'id' in newEquipment);
