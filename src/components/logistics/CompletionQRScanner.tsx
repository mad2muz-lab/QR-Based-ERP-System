// Completion QR Scanner Component
// For scanning executor ID to confirm task completion

import React, { useState, useRef, useEffect } from 'react';
import { QrCode, Camera, X, CheckCircle, AlertTriangle, User, Square } from 'lucide-react';
import QrScanner from 'qr-scanner';

interface CompletionQRScannerProps {
  executionId: string;
...
const CompletionQRScanner: React.FC<CompletionQRScannerProps> = ({
  executionId,
  assignedExecutorId,
  onSuccess,
  onCancel
  ...
  const handleQRCodeDetected = async (qrData: string) => {
    ...
    console.log('Processing completion QR data:', qrData);
    ...
    try {
      ...
      if (qrData.startsWith('{')) {
        try {
          const qrData = JSON.parse(qrData);
          employeeId = qrData.employee_id || qrData.id || qrData;
      ...
      console.log('Verifying executor ID:', employeeId);
      console.log('Assigned executor ID:', assignedExecutorId);

      // Verify that the scanned ID matches the assigned executor
      if (employeeId === assignedExecutorId) {
        // Success - this is the correct executor
        const executor = {
          id: employeeId,
          name: 'Verified Executor', // You can fetch actual name from database if needed
          role: 'Executor',
        ...
        setError('Access denied. Only the assigned executor can complete this task.');
        setScanResult(null);
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="bg-blue-50 p-3 rounded-md mb-4">
          <p className="text-sm text-blue-800">
            ...
            <strong>Security:</strong> Only assigned executor can complete this task
          </p>
        </div>
            ...
            <div className="w-full h-64 bg-gray-100 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Scan your ID card to confirm you are the assigned executor
                </p>
          ...
          {isProcessing && (
            <div className="w-full h-64 bg-gray-100 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600">Verifying executor identity...</p>
                {scanResult && (
        ...
        <div className="mt-4 text-sm text-gray-600">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Point camera at your ID card QR code</li>
            <li>Hold steady until code is detected</li>
            <li>Only the assigned executor can complete this task</li>
          </ul>
        </div>
        ...
        {import.meta.env.DEV && (
          <div className="mt-4 p-2 bg-gray-100 rounded text-xs">
            ...
            <p>Assigned Executor ID: {assignedExecutorId}</p>
...
export default CompletionQRScanner; 