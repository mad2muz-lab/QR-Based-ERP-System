  ...
  static async testDatabaseConnection(): Promise<{
    ...
    const result: any = {
      ...
      details: {
        ...
        tableAccess: {
          equipment_maintenance_logs: false,
          equipment_maintenance_schedules: false,
          equipment: false
        },
        errors: []
      }
    ...
    try {
      ...
      // Test table access
      const tables = ['equipment_maintenance_logs', 'equipment_maintenance_schedules', 'equipment'];
