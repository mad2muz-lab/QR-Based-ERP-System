-- Create Test Data for Predictive Stocking System (Final - Complete)
...
INSERT INTO materials (
  ...
  ('MAT-001', 'Engine Oil Filter', 'Spare Parts', 15, 25.00),
  ('MAT-002', 'Hydraulic Fluid', 'Spare Parts', 8, 45.00),
  ('MAT-003', 'Air Filter', 'Spare Parts', 22, 35.00),
  ('MAT-004', 'Brake Pads', 'Spare Parts', 5, 120.00),
  ('MAT-005', 'Battery', 'Spare Parts', 3, 200.00),
  ('MAT-006', 'Tire Set', 'Spare Parts', 2, 800.00),
  ('MAT-007', 'Fuel Filter', 'Spare Parts', 12, 30.00),
  ('MAT-008', 'Grease', 'Spare Parts', 25, 15.00);
