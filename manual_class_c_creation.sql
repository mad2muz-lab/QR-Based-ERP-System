-- Manual Class C Creation
-- This script manually creates Class C equipment step by step

-- =====================================================
-- 1. FIX BATCHPLANT_15 FREQUENCY
-- =====================================================
...
-- =====================================================
-- 2. MANUALLY CONVERT EQUIPMENT TO CLASS C
-- =====================================================

-- Convert first equipment to Class C (adjust name as needed)
UPDATE equipment 
SET 
    pm_class = 'Class C',
...
-- Convert second equipment to Class C (adjust name as needed)
UPDATE equipment 
SET 
    pm_class = 'Class C',
    pm_frequency_days = 90,
...
SELECT 
    'PM Class Distribution After Manual Class C Creation' as section,
    pm_class,
