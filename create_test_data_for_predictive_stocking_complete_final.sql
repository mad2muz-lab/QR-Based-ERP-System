-- Create Test Data for Predictive Stocking System (Complete Final - All Required Columns)
...
-- 2. Insert test materials data (with ALL required columns including unit)
INSERT INTO materials (
  ...
  ('MAT-001', 'Engine Oil Filter', 'Spare Parts', 'Pieces', 15),
  ('MAT-002', 'Hydraulic Fluid', 'Spare Parts', 'Liters', 8),
  ('MAT-003', 'Air Filter', 'Spare Parts', 'Pieces', 22),
  ('MAT-004', 'Brake Pads', 'Spare Parts', 'Sets', 5),
  ('MAT-005', 'Battery', 'Spare Parts', 'Units', 3),
  ('MAT-006', 'Tire Set', 'Spare Parts', 'Sets', 2),
  ('MAT-007', 'Fuel Filter', 'Spare Parts', 'Pieces', 12),
  ('MAT-008', 'Grease', 'Spare Parts', 'Kilos', 25);
