-- Migration: Add Cost Center and Profit Center functionality
-- This migration adds cost center and profit center tables and columns to existing tables
...
-- Add cost_center_code and profit_center_code columns to employees table
...
-- Add cost_center_code and profit_center_code columns to materials table
ALTER TABLE public.materials 
ADD COLUMN IF NOT EXISTS cost_center_code text,
ADD COLUMN IF NOT EXISTS profit_center_code text;

-- Add cost_center_code and profit_center_code columns to sites table
ALTER TABLE public.sites 
ADD COLUMN IF NOT EXISTS cost_center_code text,
ADD COLUMN IF NOT EXISTS profit_center_code text;

-- Add cost_center_code and profit_center_code columns to log tables for analytics
...
-- ALTER TABLE public.employees 
-- ADD CONSTRAINT employees_cost_center_code_fkey 
-- FOREIGN KEY (cost_center_code) REFERENCES public.cost_centers(code),
-- ADD CONSTRAINT employees_profit_center_code_fkey 
-- FOREIGN KEY (profit_center_code) REFERENCES public.profit_centers(code);

-- ALTER TABLE public.equipment 
-- ADD CONSTRAINT equipment_cost_center_code_fkey 
-- FOREIGN KEY (cost_center_code) REFERENCES public.cost_centers(code),
-- ADD CONSTRAINT equipment_profit_center_code_fkey 
-- FOREIGN KEY (profit_center_code) REFERENCES public.profit_centers(code);

-- ALTER TABLE public.materials 
-- ADD CONSTRAINT materials_cost_center_code_fkey 
-- FOREIGN KEY (cost_center_code) REFERENCES public.cost_centers(code),
-- ADD CONSTRAINT materials_profit_center_code_fkey 
-- FOREIGN KEY (profit_center_code) REFERENCES public.profit_centers(code);

-- ALTER TABLE public.sites 
-- ADD CONSTRAINT sites_cost_center_code_fkey 
-- FOREIGN KEY (cost_center_code) REFERENCES public.cost_centers(code),
-- ADD CONSTRAINT sites_profit_center_code_fkey 
-- FOREIGN KEY (profit_center_code) REFERENCES public.profit_centers(code);

-- Insert sample data for cost centers (temporary - you can replace with your actual data)
...
-- Insert sample data for profit centers (temporary - you can replace with your actual data)
...
CREATE INDEX IF NOT EXISTS idx_time_logs_cost_center ON public.time_logs(cost_center_code);
CREATE INDEX IF NOT EXISTS idx_time_logs_profit_center ON public.time_logs(profit_center_code);
