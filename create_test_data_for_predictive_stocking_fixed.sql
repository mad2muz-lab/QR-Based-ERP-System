-- Create Test Data for Predictive Stocking System (Fixed)
...
INSERT INTO equipment (
  ...
  ('EQUIP-001', 'Excavator-01', 'Excavator', 'CAT 320', 'Class A', true, 30, 2500.00, 'available'),
  ('EQUIP-002', 'Bulldozer-01', 'Bulldozer', 'CAT D6', 'Class B', true, 45, 1800.00, 'available'),
  ('EQUIP-003', 'Crane-01', 'Crane', 'Liebherr LTM', 'Class C', true, 90, 3500.00, 'available'),
  ('EQUIP-004', 'Loader-01', 'Loader', 'CAT 950', 'Class A', true, 30, 2000.00, 'available'),
  ('EQUIP-005', 'Paver-01', 'Asphalt Paver', 'CAT AP655', 'Class B', true, 60, 2200.00, 'available');
