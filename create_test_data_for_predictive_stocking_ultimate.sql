-- Create Test Data for Predictive Stocking System (Ultimate - All Required Columns)
-- This script creates test equipment and materials data for independent testing

-- 1. Insert test equipment data (with ALL required columns including qr_code)
INSERT INTO equipment (
  ...
  ('EQUIP-001', 'Excavator-01', 'Excavator', 'CAT 320', 'Site A', 'EXC-001', 'Class A', true, 30, 2500.00, 'available'),
  ('EQUIP-002', 'Bulldozer-01', 'Bulldozer', 'CAT D6', 'Site A', 'BUL-001', 'Class B', true, 45, 1800.00, 'available'),
  ('EQUIP-003', 'Crane-01', 'Crane', 'Liebherr LTM', 'Site B', 'CRA-001', 'Class C', true, 90, 3500.00, 'available'),
  ('EQUIP-004', 'Loader-01', 'Loader', 'CAT 950', 'Site A', 'LOA-001', 'Class A', true, 30, 2000.00, 'available'),
  ('EQUIP-005', 'Paver-01', 'Asphalt Paver', 'CAT AP655', 'Site B', 'PAV-001', 'Class B', true, 60, 2200.00, 'available');

-- 2. Insert test materials data (with ALL required columns including site and unit)
INSERT INTO materials (
  ...
  ('MAT-001', 'Engine Oil Filter', 'Spare Parts', 'Pieces', 'Site A', 15),
  ('MAT-002', 'Hydraulic Fluid', 'Spare Parts', 'Liters', 'Site A', 8),
  ('MAT-003', 'Air Filter', 'Spare Parts', 'Pieces', 'Site B', 22),
  ('MAT-004', 'Brake Pads', 'Spare Parts', 'Sets', 'Site A', 5),
  ('MAT-005', 'Battery', 'Spare Parts', 'Units', 'Site B', 3),
  ('MAT-006', 'Tire Set', 'Spare Parts', 'Sets', 'Site A', 2),
  ('MAT-007', 'Fuel Filter', 'Spare Parts', 'Pieces', 'Site B', 12),
  ('MAT-008', 'Grease', 'Spare Parts', 'Kilos', 'Site A', 25);

-- 3. Now create predictive stocking sample data
...
-- 4. Insert sample AI learning data
...
-- 6. Insert sample accuracy tracking data
