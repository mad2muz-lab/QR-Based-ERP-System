-- Create Test Data for Predictive Stocking System (Working - No unit_price)
...
-- 2. Insert test materials data (without unit_price column)
INSERT INTO materials (
  ...
  ('MAT-001', 'Engine Oil Filter', 'Spare Parts', 15),
  ('MAT-002', 'Hydraulic Fluid', 'Spare Parts', 8),
  ('MAT-003', 'Air Filter', 'Spare Parts', 22),
  ('MAT-004', 'Brake Pads', 'Spare Parts', 5),
  ('MAT-005', 'Battery', 'Spare Parts', 3),
  ('MAT-006', 'Tire Set', 'Spare Parts', 2),
  ('MAT-007', 'Fuel Filter', 'Spare Parts', 12),
  ('MAT-008', 'Grease', 'Spare Parts', 25);
