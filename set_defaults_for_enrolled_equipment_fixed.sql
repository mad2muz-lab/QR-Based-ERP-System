...
-- =====================================================
-- 4. SET LAST PM DATE FOR EQUIPMENT WITHOUT IT
-- =====================================================
...
-- =====================================================
-- 5. CALCULATE NEXT PM DATES FOR ALL ENROLLED EQUIPMENT
-- =====================================================
...
-- =====================================================
-- 6. SET FREQUENCY HOURS FOR ALL ENROLLED EQUIPMENT
-- =====================================================
...
SET pm_frequency_hours = 
    CASE 
        WHEN pm_class = 'Class A' THEN 720
        WHEN pm_class = 'Class B' THEN 8760
        WHEN pm_class = 'Class C' THEN 17520
        ELSE 720
    END
WHERE is_pm = true 
...
-- =====================================================
-- 7. SET DEFAULT CHECKLIST ITEMS FOR ALL ENROLLED EQUIPMENT
-- =====================================================

-- Set default checklist items for equipment that don't have them
UPDATE equipment 
SET pm_checklist_items = ARRAY['Inspect general condition', 'Check fluid levels', 'Test safety systems', 'Clean equipment', 'Document findings']
WHERE is_pm = true 
  AND (pm_checklist_items IS NULL OR array_length(pm_checklist_items, 1) = 0);

-- =====================================================
-- 8. SET DEFAULT SPARE PARTS FOR ALL ENROLLED EQUIPMENT
-- =====================================================

-- Set default spare parts for equipment that don't have them
UPDATE equipment 
SET pm_spare_parts = ARRAY['Oil filter', 'Air filter', 'Hydraulic fluid', 'Grease']
WHERE is_pm = true 
